  ...
  try {
    ...
    return (
      <div className="p-6 rounded-xl bg-neutral-900/50 border border-neutral-800">
        ...
        {activities.length === 0 ? (
          <p className="text-sm text-neutral-400">No activity yet. Create your first lead or project!</p>
        ) : (
          <div className="space-y-4">
            {activities.map((activity) => (
              <Link
                ...
                className="flex items-start gap-4 p-3 rounded-lg hover:bg-neutral-800/50 transition-colors"
              >
