...
/**
 * RecentActivityRealtime - Client Component con Supabase Realtime
 * Se actualiza automáticamente cuando se crean/modifican leads o projects
 */
export function RecentActivityRealtime() {
  ...
  useEffect(() => {
    ...
    leadsChannel = supabase
      ...
      .on(
        ...
        () => {
          console.log('📝 Lead activity detected - refreshing');
          fetchActivities();
        }
      )
      .subscribe();
    ...
    projectsChannel = supabase
      ...
      .on(
        ...
        () => {
          console.log('📝 Project activity detected - refreshing');
          fetchActivities();
        }
      )
      .subscribe();
  ...
  return (
    <div className="p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md relative">
